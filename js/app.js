...
bdApp.service('mapService', function(){
    ...
    this.init = function initMap() {
        ...
        this.calculateAndDisplayRoute(directionsService, directionsDisplay, "Chicago", "Washington D.C.");
        
        
      };
    this.calculateAndDisplayRoute = function(originString, destinationString) {
